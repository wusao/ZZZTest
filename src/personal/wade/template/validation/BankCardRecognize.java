...
public class BankCardRecognize {
	...
	private final static Logger logger = LoggerFactory.getLogger(BankCardRecognize.class);
	    ...
	    public static void main(String[] args)
	    {
			...
			System.out.println(bankBin[0] + " : " + bankName[0]);
			
	    	if(bankBin.length >= bankName.length)
	    	{
	    		for(int i=1; i < bankBin.length; i++)
	    		{
	    			if(bankBin[i-1] != bankBin[i])
